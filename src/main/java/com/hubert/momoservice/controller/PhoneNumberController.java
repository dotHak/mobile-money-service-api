...
public class PhoneNumberController {
    ...
    public List<PhoneNumber> getMerchantPhoneNumbers(Principal principal, @PathVariable Long merchantId){
        var user = userService.findUserEmail(principal.getName());
    ...
    public PhoneNumber addUserNewPhoneNumber
        ...
        try{
            ...
            throw new BadRequestException(
                    e.getCause().getMessage() + ", (number) = (" + phoneNumber.getNumber() + ") already exists");
        }
        ...
        if(user.isPresent()){
            ...
            else if(phoneNumber.getDefault()){
